...
我是 TypeScript 严格模式检查技能，专门针对 Home-MCP 项目的严格 TypeScript 配置进行类型安全检查和修复建议。
...
通过这个技能，可以确保 Home-MCP 项目始终保持高质量的 TypeScript 代码标准，减少运行时错误，提升开发效率。